    ...
    <div className="max-w-7xl mx-auto">
      <div className="p-4 max-w-full">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-medium  text-[#34A853]">Your newest matches</h2>
          <button className="text-sm font-semibold text-[#34A853] underline hover:underline mr-12">View All Jobs</button>
        </div>
