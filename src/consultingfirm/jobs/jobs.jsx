  ...
  return (
    <div className="w-full min-h-screen flex flex-col bg-white">
      <div className="flex-1 flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-3/4 p-4 sm:p-6 md:p-8">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-8">
              <div className="bg-[#C7E1FF] rounded-2xl p-6 md:p-8 md:w-1/2 h-48 md:h-72 flex items-center">
              ...
              <div className="rounded-2xl border-2 border-blue-200 p-6 md:p-8 md:w-1/2 flex items-center justify-center text-left">
            ...
            <div className="space-y-8 md:space-y-12">
              {matches.map((job, idx) => (
                <div
                  key={idx}
                  className="bg-white shadow-lg rounded-xl p-6 sm:p-8 flex flex-col md:flex-row md:justify-between md:items-center min-h-[180px] md:h-44 cursor-pointer transition hover:shadow-xl"
                ...
                >
                  <div className="flex flex-row items-center gap-4">
                    ...
                    <div className="ml-2 sm:ml-4">
                      ...
                      <p className="text-xs text-gray-600 mt-2 mb-4 flex flex-wrap items-center w-full sm:w-[300px]">
                  ...
                  <div className="text-left md:text-right mt-4 md:mt-0 flex flex-col items-start md:items-end">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mt-2">
                      {job.skills.map((skill, index) => (
                        <span
                          key={index}
                          className="text-xs sm:text-sm border border-gray-300 px-2 py-1 rounded-lg"
                        >
                          {skill}
                        </span>
                      ))}
        ...
        {/* Sidebar */}
        <div className="w-full lg:w-1/4 p-4 sm:p-6 md:p-6 lg:p-6 mt-6 lg:mt-0 rounded-lg">
