  ...
  return (
    <section className="py-12">
      <div className="max-w-6xl mx-auto px-4 text-center">
        {/* Pricing Heading */}
        <h3 className="text-3xl font-sm mb-8 text-black ">Pricing</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
          {plans.map((plan, index) => {
            ...
            return (
              <div
                key={index}
                className={`relative rounded-3xl p-8 flex flex-col shadow-md ${cardBgClass} mx-auto`}
              >
                {/* Plan Name */}
                ...
                <p className="mb-1 font-medium">{plan.seatPrice}</p>
                <p>{getBillingText()}</p>
        ...
        <div className="mt-12 border border-[#4E96F7] rounded-2xl py-6 px-8 flex flex-col md:flex-row items-center justify-between shadow-sm shadow-[#4E96F7]">
          ...
          <button
            type="button"
            className="bg-[#377DFF] text-white font-semibold py-3 px-6 rounded-full hover:bg-[#2663dc] transition-colors"
          >
            Start Trial
          </button>
        </div>
