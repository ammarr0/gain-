...
const cards = [
  {
    ...
    subtext:
      'Explore a wide range of AI and tech job opportunities tailored to your skills and interests. Apply easily and take the next step in your career journey.',
    button: 'Browse Jobs',
    color: 'bg-[#C7E1FF]',
    link: '/talent/jobs',
  },
  {
    ...
    subtext:
      'Connect with top AI professionals and build your dream team. Post projects and find the perfect match for your business needs.',
  ...
  },
  {
    ...
    subtext:
      'Upskill yourself with the latest AI courses or share your expertise by teaching others. Join a vibrant learning community.',
    button: 'Browse Courses',
    color: 'bg-[#CACDFF]',
    link: '/talent/explore-course',
  },
];
...
const DashboardCards = () => (
  <div className="px-2 sm:px-4 py-2 w-full">
    <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-3 w-full">
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-3 w-full justify-center">
        {cards.map((card, idx) => (
          <div
            key={idx}
          ...
          >
            <div className="w-full">
              <p className="font-semibold text-lg sm:text-xl md:text-2xl text-left mb-2">
                {card.text}
              </p>
              <p className="text-gray-700 text-sm md:text-base text-left mb-4">
                {card.subtext}
              </p>
            </div>
            <a
