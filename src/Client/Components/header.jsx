...
const menuItems = [
  ...
  { name: 'Explore Talents', icon: <Globe size={24} color="#313131" />, route: '/client/explore-talent' },
  { name: 'Invoices', icon: <Wallet size={24} color="#313131" />, route: '/client/my-invoices' }
];
...
const Header = () => {
  ...
  const handleSearchSubmit = (e) => {
    e.preventDefault();
    if (searchValue.trim()) {
      navigate(`/client/jobs?search=${encodeURIComponent(searchValue)}`);
      setSearchOpen(false);
      setSearchValue('');
    }
  };
